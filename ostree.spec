...
Version  : 2019.5
Release  : 35
URL      : https://github.com/ostreedev/ostree/releases/download/v2019.5/libostree-2019.5.tar.xz
Source0  : https://github.com/ostreedev/ostree/releases/download/v2019.5/libostree-2019.5.tar.xz
...
%prep
%setup -q -n libostree-2019.5
cd %{_builddir}/libostree-2019.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572547223
...
cp %{_builddir}/libostree-2019.5/COPYING %{buildroot}/usr/share/package-licenses/ostree/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/libostree-2019.5/bsdiff/LICENSE %{buildroot}/usr/share/package-licenses/ostree/4ee6d2132726e5074e6917e113cf34d3cf625ce2
cp %{_builddir}/libostree-2019.5/libglnx/COPYING %{buildroot}/usr/share/package-licenses/ostree/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
