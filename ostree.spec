...
%prep
%setup -q -n libostree-2020.5
cd %{_builddir}/libostree-2020.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597788981
...
cp %{_builddir}/libostree-2020.5/COPYING %{buildroot}/usr/share/package-licenses/ostree/ba8966e2473a9969bdcab3dc82274c817cfd98a1
cp %{_builddir}/libostree-2020.5/bsdiff/LICENSE %{buildroot}/usr/share/package-licenses/ostree/4ee6d2132726e5074e6917e113cf34d3cf625ce2
cp %{_builddir}/libostree-2020.5/libglnx/COPYING %{buildroot}/usr/share/package-licenses/ostree/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
