...
%prep
%setup -q -n libostree-2019.6
cd %{_builddir}/libostree-2019.6
...
cp %{_builddir}/libostree-2019.6/bsdiff/LICENSE %{buildroot}/usr/share/package-licenses/ostree/4ee6d2132726e5074e6917e113cf34d3cf625ce2
cp %{_builddir}/libostree-2019.6/libglnx/COPYING %{buildroot}/usr/share/package-licenses/ostree/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
